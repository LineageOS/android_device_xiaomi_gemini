...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final String FP_HOME_KEY_NODE = "/sys/devices/soc/soc:fpc_fpc1020/enable_key_events";
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        boolean fingerprintHomeButtonEnabled = FileUtils.readOneLine(FP_HOME_KEY_NODE).equals("1");
