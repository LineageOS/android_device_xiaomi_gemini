...
public class KeyDisabler {
    ...
    public static boolean isSupported() {
        ...
        return FileUtils.isFileWritable(CONTROL_PATH) && FileUtils.isFileReadable(CONTROL_PATH) && FileUtils.isFileWritable(FP_HOME_PATH) && FileUtils.isFileReadable(FP_HOME_PATH);
    }
    ...
    public static boolean setActive(boolean state) {
        return FileUtils.writeLine(CONTROL_PATH, (state ? "0" : "1")) && FileUtils.writeLine(FP_HOME_PATH, (state ? "0" : "1"));
    }
}
